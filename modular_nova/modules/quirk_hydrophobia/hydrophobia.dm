...
/datum/quirk/hydrophobia/add(client/client_source)
	...
	var/datum/action/cooldown/slime_hydrophobia/slime_hydrophobia = locate() in quirk_holder.actions // OCULIS EDIT CHANGE - SLIMEPEOPLE - ORIGINAL: var/datum/action/cooldown/spell/slime_hydrophobia/slime_hydrophobia = locate() in quirk_holder.actions
